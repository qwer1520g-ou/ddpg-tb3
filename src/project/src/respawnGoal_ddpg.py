...
class Respawn():
    def __init__(self,m4):
        ...
        if self.m4 == '4*4':
            ...
            self.init_goal_y = -1.3
        elif self.m4== '2*2':
            self.init_goal_x = 0.65 
            self.init_goal_y = -0.6
        elif self.m4== '2*1':
            self.init_goal_x = 0.78 
            self.init_goal_y = 0.23
        else:
            self.init_goal_x = 0.71 
            self.init_goal_y = 0.28
            
        self.goal_position.position.x = self.init_goal_x
        self.goal_position.position.y = self.init_goal_y
        self.modelName = 'goal'
        #stage2:    value is 0.6
        #stage2_2m: value is 0.4
        #self.obstacle_1 = 0.30, 0.30
        #self.obstacle_2 = 0.30, -0.30
        #self.obstacle_3 = -0.30, 0.30
        #self.obstacle_4 = -0.30, -0.30
        self.obstacle_1 = 0.7, 0.6
        self.obstacle_2 = 0.7, -0.6
        self.obstacle_3 = -0.5, 0.6 #-0.6,0.6
        self.obstacle_4 = -0.5, -0.6#-0.6,-0.6
